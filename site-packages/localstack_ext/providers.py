...
@pro_aws_provider(api=_B,name='stream_pro')
def s3_stream():from localstack_ext.services.s3.provider_stream import S3ProviderStreamPro as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
