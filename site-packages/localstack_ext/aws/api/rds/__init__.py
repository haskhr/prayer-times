...
class RdsApi:
    ...
    def create_db_instance(
        ...
        :param db_name: The meaning of this parameter differs depending on the database engine.
    ...
    def modify_db_instance(
        ...
        :param tde_credential_password: The password for the given ARN from the key store in order to access the
        device.
        :param ca_certificate_identifier: The CA certificate identifier to use for the DB instance6's server
        certificate.
